...
export const players = sqliteTable('players', {
  ...
  rating960: integer('rating960').default(1200).notNull(),
  wins: integer('wins').default(0).notNull(),
  losses: integer('losses').default(0).notNull(),
  draws: integer('draws').default(0).notNull(),
  wins960: integer('wins960').default(0).notNull(),
  losses960: integer('losses960').default(0).notNull(),
  draws960: integer('draws960').default(0).notNull(),
  peakRating: integer('peak_rating').default(1200).notNull(),
  peakRating960: integer('peak_rating960').default(1200).notNull(),
...
export const games = sqliteTable('games', {
  ...
  blackPlayerId: text('black_player_id')
    .references(() => players.id)
    .notNull(),
  status: text('status', { enum: ['ongoing', 'completed', 'draw', 'paused'] })
    .default('ongoing')
    .notNull(),
  variant: text('variant', { enum: ['standard', 'chess960'] })
    .default('standard')
    .notNull(),
  startPosId: integer('start_pos_id'),
