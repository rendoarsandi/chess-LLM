...
## 5. Out of Scope
- Elo rating updates for Tournament games (Tournament performance is tracked separately or optionally affects main Elo). *Decision: Affects main Elo for simplicity unless specified otherwise.*
