...
export function useArenaState() {
  ...
  return {
    ...
    games, selectedGame, moves, players, leaderboard,
    boardOrientation, setBoardOrientation,
    activeMoveIndex, setActiveMoveIndex,
    showResultOverlay, setShowResultOverlay,
    lastMoveSquares, whitePlayerId, setWhitePlayerId,
    blackPlayerId, setBlackPlayerId, isCreatingGame,
    spectatorCount, thinkingStatus, variant: currentVariant,
    handleSelectGame, fetchAllGames, handleCreateGame,
    handleDeleteGame, handleClearHistory, handleTogglePause,
    currentDisplayFen, currentPgn, isLive, evaluation,
    variations, isThinking, whitePlayer, blackPlayer,
    hasOngoingGame, whiteThinking, blackThinking
  };
}
