...
describe('ClassificationEngine', () => {
  ...
  it('should classify Brilliant for a "sacrifice" that is good', () => {
    // Simplified brilliant logic: best move that was low eval before but high after?
    // Actually brilliant usually involves a material sacrifice.
    // For now we'll use a placeholder logic: best move + significant gain + was previously difficult.
    const context: MoveContext = {
      beforeEval: -0.5,
      bestMoveEval: 1.2,
      moveEval: 1.2,
