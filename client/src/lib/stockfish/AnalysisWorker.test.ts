...
describe('AnalysisWorker', () => {
  ...
  it('should analyze a position and return multi-pv results', async () => {
    ...
    mockWorker.simulateMessage('info depth 1 seldepth 1 multipv 1 score cp 35 nodes 20 nps 20000 pv e2e4');
    mockWorker.simulateMessage('info depth 1 seldepth 1 multipv 2 score cp 20 nodes 20 nps 20000 pv d2d4');
    mockWorker.simulateMessage('info depth 1 seldepth 1 multipv 3 score cp 15 nodes 20 nps 20000 pv g1f3');
    // ... more depth ...
    mockWorker.simulateMessage('info depth 10 seldepth 15 multipv 1 score cp 40 nodes 1000 nps 100000 pv e2e4 e7e5');
    mockWorker.simulateMessage('info depth 10 seldepth 15 multipv 2 score cp 25 nodes 1000 nps 100000 pv d2d4 d7d5');
    mockWorker.simulateMessage('info depth 10 seldepth 15 multipv 3 score cp 10 nodes 1000 nps 100000 pv g1f3 d7d5');
