  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 md:gap-4">
      {stats.map((stat, idx) => (
        <div
          key={idx}
          className="bg-card border border-border p-3 md:p-4 rounded-xl flex flex-col items-center justify-center text-center space-y-2 shadow-sm"
        >
          ...
          <div className="space-y-0.5">
            ...
            <div className="text-[9px] md:text-[10px] font-bold uppercase tracking-widest text-muted-foreground">
              {stat.label}
            </div>
            {'subValue' in stat && (
