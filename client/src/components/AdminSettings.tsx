...
import { Settings, Plus, Trash2, Power, PowerOff, ShieldCheck, ShieldAlert, Loader2 } from "lucide-react"
import { getAdminModels, createAdminModel, updateAdminModel, deleteAdminModel, type LLMConfig } from "../api"
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-muted/50">
                                <TableHead className="font-black uppercase tracking-widest text-[10px]">Provider</TableHead>
                                <TableHead className="font-black uppercase tracking-widest text-[10px]">Model ID</TableHead>
                        ...
                        <TableBody>
                            {isLoading ? (
                                ...
                                <TableRow key={config.id} className="group hover:bg-muted/30 transition-colors">
                                    <TableCell className="font-bold uppercase tracking-tighter text-primary">{config.provider}</TableCell>
                                        ...
                                        <div className="flex items-center justify-end gap-2">
                                            <Button 
                                                ...
                                                className={cn(
                                                    ...
                                                    config.isActive ? "text-muted-foreground" : "text-green-500 border-green-500/20 hover:bg-green-500/10"
                                                )}
