      ...
      <div className="max-w-6xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-muted-foreground font-medium">
            Live and historical Swiss system tournaments.
          </p>
        </div>
        ...
        {scheduled.length > 0 && (
          <section className="space-y-6">
            <h3 className="text-xl font-black uppercase tracking-widest italic text-muted-foreground">
              Upcoming
            </h3>
        ...
        {!isLoading && tournaments.length === 0 && (
          <div className="bg-card rounded-xl border border-border p-12 text-center space-y-4">
            ...
            <p className="text-muted-foreground font-bold uppercase tracking-widest">
              No tournaments scheduled at this time.
            </p>
          </div>
        )}
      </div>
