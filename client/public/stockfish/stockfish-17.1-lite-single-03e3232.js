      ...
      var P,
        ...
        Me =
          (!(function () {
            ...
            var o = { a: Ce }
            if ((b++, l.monitorRunDependencies && l.monitorRunDependencies(b), l.instantiateWasm))
              try {
          ...
          var a = {
              string: function (e) {
                var n,
                  t = 0
                return (
                  null != e && 0 !== e && ((n = 1 + (e.length << 2)), (t = Y(n)), G(e, y, t, n)),
                  t
                )
              },
              array: function (e) {
        ...
        (function (n) {
          return function (e) {
            ;(++r,
              (o[n] = e),
              r === t &&
                ((e = URL.createObjectURL(new Blob(o, { type: 'application/wasm' }))), u(e)))
          }
        })(e),
      )
  }
